...
string DNKL(lista* l, int i)
{
    DNPL(l, i);
    *l = (*l)->nast;
    return "poprawnie dodano wartosc za elementem";
}
...
string wyswietl_obie(lista l) {
    ...
    if (l) {
        ...
        return "[ ] [ ]";
    while (l && l != start) {
        komunikat = komunikat + " " + to_string(l->klucz);
        l = l->nast;
    }
    komunikat = "[ " + komunikat + " ]";
    l = l->pop;
    ...
    while (l && l != start) {
        komunikat2 = komunikat2 + " " + to_string(l->klucz);
        l = l->pop;
    }
...
string UPL(lista* l) {
    lista p = 0;
    if (*l == NULL) return "lista byla pusta wiec nic nie usunieto";
    p = (*l)->nast;
    if (p == *l) {
        free(*l);
        *l = NULL;
...
string zad11(lista* l, int k) {
    ...
    return "pozostala wartosc " + to_string((*l)->klucz);
}
...
int main()
{
    ...
    while (1) {
        ...
        case 15:
            ...
            break;
        case 16:
            cout << "co ktory element usuwac? ";
            cin >> numer;
            komunikat = zad11(&l, numer);
            break;
        case 17:
